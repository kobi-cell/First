...
## באגים ב-`zk-write-test.ps1` שכדאי לתקן
...
### באג 3 — `-Door` נדרש ב-`remove` אך ברירת המחדל שלו שקטה

`remove` בלי `-Door` רץ עם ברירת המחדל 1. אם מחיקת רשומת ההרשאה נעשית לפי מספר
דלת, מחיקה של הרשאה שנכתבה לדלת 4 תשאיר רשומה יתומה. בבדיקה הזו העברנו `-Door 4`
במפורש והביקורת יצאה נקייה, אז זה לא אומת בשטח — אבל שווה בדיקה בקוד.
